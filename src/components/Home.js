      ...
      <div className="home">
        <div className="container">
          <div className="hero">
            ...
            <section>
              Рада приветствовать Вас на своём сайте! Меня зовут Екатерина
              Воржакова - я фотограф из Челябинска.
            </section>
            <button className="btn">Заказать съёмку</button>
          </div>
          <div className="runner-box">
            <Marquee>{this.items}</Marquee>
          </div>
          <div className="credo">
            <div className="container">
              ...
              <div className="credo_text">
                ...
                Оно помнит мелочи, даже после того, как Вы всё забыли ».
                <br />– Аарон Сискинд
              </div>
            </div>
            <Footer />
